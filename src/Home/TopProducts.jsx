...
const content = (
  <div className="flex flex-col gap-5 w-[90%] mx-auto my-16">
    <h1 className="text-xl text-black font-bold">Top Products</h1>
      ...
      {data.map((item) => (
        ...
        >
          ...
          <div className="card-body">
            ...
            <p className="text-slate-200 text-bold">₱ {item.price}.00</p>
            <div className="card-actions justify-end">
              <div className="badge badge-outline text-slate-200">Gadget</div>
              <div className="badge badge-outline text-slate-200">Products</div>
            </div>
          </div>
        </div>
      ))}
